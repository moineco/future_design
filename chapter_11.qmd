...
-   A market-clearing price balances supply and demand and can be graphically represented as the intersection of the supply and demand curves.
    ...
    ![](figures/L11/market-equilibrium.png)
...
- Externalities: Externalities occur when the consumption of a good or service benefits or harms a third party.

- Information failure: When there is insufficient information available to certain participants in the market, this can also be the source of market failure.
...
- Public goods: Public goods are another example of market failure because they defy the tenets of supply and demand that drive the free markets.

## Worst Market Failures in Human History
...
- Negative Externality: The core issue is that burning fossil fuels and other activities generate pollution (like \(\text{CO}_{2}\)), but the price of energy doesn't reflect the damage these emissions cause to the climate and future generations, notes ClimateScience and LSE.

- Unpriced Costs: The economic system doesn't account for costs like biodiversity loss, ocean acidification, and severe weather, forcing society to pay for them later, according to ClimateScience.

- Intergenerational Equity: Polluters today shift massive costs onto future generations, who have no say in current emissions

Stern Review on the Economics of Climate Change: 

<https://webarchive.nationalarchives.gov.uk/ukgwa/+/http://www.hm-treasury.gov.uk/sternreview_index.htm>
