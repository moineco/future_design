...
Mangroves, tidal marshes, and seagrasses have been recognized as blue carbon coastal ecosystems as they accommodate large carbon stocks, enable long-term carbon storage, have the capacity to control greenhouse gas emissions and possess the potential to reduce the rise in atmospheric CO2 levels.

![Mangrove in Okinawa, Japan](figures/L12/L12_10.webp){fig-align="center" width="569"}
...
### Organic nitrogen fertilizer use in wineries of Australia

Australian organic wineries manage nitrogen naturally through cover crops (legumes like medic fix nitrogen), compost, and bio-dynamic practices, reducing reliance on synthetic fertilizers.

![](figures/L12/L12_7.jpg){fig-align="center" width="483"}

![](figures/L12/L12_8.jpg){fig-align="center"}

Leguminous crops (such as soybeans, alfalfa, peanuts, beans, and clover) possess a unique ability to utilize nitrogen, often thriving in nitrogen-deficient soils through a symbiotic relationship with Rhizobium bacteria.

![](figures/L12/L12_9.jpg){fig-align="center" width="483"}
